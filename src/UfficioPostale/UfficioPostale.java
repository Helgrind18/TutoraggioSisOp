...
public abstract class UfficioPostale {
    ...
    public abstract void prossimoCliente(String operazione) throws InterruptedException;
    public abstract void eseguiOperazione(String operazione) throws InterruptedException;
    ...
    public void test(int numClienti) throws InterruptedException{
        ...
        for(int i = 0; i < numFile; i++){
            impiegati[i] = new Impiegato(this, ""+operazioni.charAt(i),i);
